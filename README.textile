...
Options:
  ...
  up:
    ...
    -z ZONE, --zone=ZONE
                        ...
                        (default: us-east-1d). If using multi zones, use comma
                        to delimit ex: eu-west-1a,us-west-2b
  ...
  attack:
    ...
    -P CONTENTTYPE, --contenttype=CONTENTTYPE
                        ...
                        attack.
    -j HLX_COMMANDS, --hlx=HLX_COMMANDS
                        hlx options
    -o, --long_output   full hlx output
    ...
    -w, --wide_attack   Commence load test from multiple regions
</pre>
